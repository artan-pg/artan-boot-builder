...
/**
 * Interceptor that can be registered with a {@link DomainEventMulticaster} to
 * observe and optionally influence the processing of domain events.
 *
 * <p>Typical use cases include:
 * <ul>
 *   <li>Logging and auditing</li>
 *   <li>Metrics collection (e.g. Micrometer)</li>
 *   <li>Distributed tracing (e.g. OpenTelemetry)</li>
...
public interface DomainEventInterceptor {
     ...
     *
     * <p>This method is called only when {@link DomainEventListener#process(DomainEvent)}
